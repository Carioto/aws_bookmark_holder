...
const AddBookmark = () => {
    ...
    const [bookmark, setBookmark] = useState({url:'', description:'', category:'',id:userId });
    ...
    return (
        ...
        <input 
          ...
          /> 
          <button className="addBookSub" type="submit">Submit</button>
          <button ><Link to="/" className="text-black homeBut">Go Back</Link></button>
